...
def main():
    ...
    if suffix == '':
        save_path =  './denoise_earlyfusion_'+ 'dim'+ str(dim)  +'/'
    else:
        if key == '':
            save_path = './denoise_earlyfusion_'+ 'dim' + str(dim) +'_'+ suffix  +'/'
        else:
            save_path = './denoise_earlyfusion_'+ 'dim' + str(dim) + '_'+ suffix+ '_' + key  +'/'
    ...
    if resume_training == False:
        if inference == False:
            print('Train Model')
            latent_representation = earlyfusion.Autoencoder_entry(train_obj,
    ...
    txt_name = save_path + 'earlyfusion_' + 'dim_' + str(dim) +'_'  + timer + '.txt'
